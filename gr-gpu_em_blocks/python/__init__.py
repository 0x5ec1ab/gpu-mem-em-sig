...
'''
This is the GNU Radio GPU_EM_BLOCKS module. Place your Python package
...
# import swig generated symbols into the gpu_em_blocks namespace
try:
    # this might fail if the module is python-only
    from .gpu_em_blocks_swig import *
